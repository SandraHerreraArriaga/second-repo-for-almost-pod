#
# Be sure to run `pod lib lint almost-pod.podspec' to ensure this is a
...
Espero que se pueda implementar esta libreria en cocoapods
  ...
  s.source           = { :git => 'https://github.com/SandraHerreraArriaga/almost-pod.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'almost-pod/Classes/**/*'
  
  # s.resource_bundles = {
  #   'almost-pod' => ['almost-pod/Assets/*.png']
  # }
